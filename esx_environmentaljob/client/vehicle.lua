...
function OpenVehicleSpawnerMenu(type, station, part, partNum)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle', {
		...
		if data.current.action == 'buy_vehicle' then
			local shopElements = {}
			local shopCoords = Config.environmentalStations[station][part][partNum].InsideShop
					...
					for k,v in ipairs(jobVehicles) do
						...
						if IsModelInCdimage(props.model) then
							...
							if v.stored then
								...
								label = label .. ('<span style="color:orange;">%s</span>'):format(_U('garage_notstored'))
							end
							...
							if data2.current.stored then
								...
								if foundSpawn then
									...
									ESX.Game.SpawnVehicle(data2.current.model, spawnPoint.coords, spawnPoint.heading, function(vehicle)
										...
										TriggerServerEvent('esx_advancedgarage:setVehicleState', data2.current.plate, false)
...
function StoreNearbyVehicle(playerCoords)
	...
	ESX.TriggerServerCallback('esx_environmentaljob:storeNearbyVehicle', function(storeSuccess, foundNum)
...
function GetAvailableVehicleSpawnPoint(station, part, partNum)
	local spawnPoints = Config.environmentalStations[station][part][partNum].SpawnPoints
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop', {
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop_confirm', {
			...
			if data2.current.value == 'yes' then
				...
				ESX.TriggerServerCallback('esx_environmentaljob:buyJobVehicle', function (bought)
					if bought then
