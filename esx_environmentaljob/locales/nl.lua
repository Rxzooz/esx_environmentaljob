Locales['nl'] = {
    ...
    ['confirm_yes'] = 'Ja',
    -- Service
    ['service_max'] = 'Je kan niet in dienst gaan, maximale aantal environmentalen in dienst: %s/%s',
    ...
    ['service_in_announce'] = 'environmental ~y~%s~s~ is nu in dienst!',
    ['service_out'] = 'Je bent nu uit dienst, fijne dag.',
    ['service_out_announce'] = 'environmental ~y~%s~s~ is nu niet meer in dienst.',
    -- Action Menu
